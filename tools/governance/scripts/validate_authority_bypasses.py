#!/usr/bin/env python3
# Tools/governance/scripts/validate_authority_bypasses.py
# Architecture Validator: Detect runtime authority bypasses
...
def main():
    print(f"\n{BOLD}{BLUE}=== AUTHORITY BYPASS VALIDATION (P1-Runtime-Architecture-Lockdown) ==={NC}")
    ...
    for swift_file in swift_files:
        try:
            ...
            if matches:
                ...
                if "DatabaseCore" in file_path or "DatabaseAuthority" in file_path:
                    continue
    ...
    # Check 3: Direct evidence writes outside EvidenceAuthority
    print(f"\n{BOLD}Check 3: Evidence system bypasses{NC}")
