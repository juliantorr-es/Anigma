...
**This is NOT related to PDFium linker contamination** (td-7c0153 Phase 2 has architecturally isolated PDFium linkage). These are separate ownership/API errors.
