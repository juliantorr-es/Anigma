...
// MARK: - Stub: UniversalExportView
// ExportUI module unavailable; providing stub implementation
struct UniversalExportView: View {
    let engine: Any?
    var body: some View {
        VStack {
            Text("Export functionality")
                .font(.headline)
            Text("ExportUI module unavailable")
    ...
    var body: some View {
        ...
        NavigationSplitView {
            ...
            VStack(spacing: 0) {
                ...
                if store.daemonStore.daemonBridge == nil {
                    DaemonWarningBanner()
                }
        ...
        .sheet(isPresented: $bindableStore.isHarmoniaCliPresented) {
            HarmoniaCliView(
                backendResolver: {
                    let client = store.daemonCapability.harmonia
                    return HarmoniaClientBackend(client: client)
                },
                history: store.harmoniaCommandHistory ?? HarmoniaCommandHistory()
            )
                .frame(minWidth: 800, minHeight: 600)
        }
        ...
        List(selection: $bindableAppState.selectedSurface) {
            ...
            case .build:
                ...
                Section("Platform") {
                    ...
                    SidebarRow(title: "Vault", icon: "shield.checkered")
    ...
    var body: some View {
        ...
        case .projects:
            if let project = store.currentProject {
                WorkbenchView(
                    project: AnigmaWork.WorkbenchProject(
            ...
            Button {
                ...
                Task {
                    do {
                        ...
                        store.daemonStore.daemonBridge = try await SidecarBridge.create(
