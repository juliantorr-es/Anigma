    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            HStack(spacing: Bauhaus.Grid.x2) {
                DevelopFilterChip(label: "Files", isSelected: true)
                    .accessibilityLabel("Filter by Files")
                    .accessibilityAddTraits(.isSelected)
                DevelopFilterChip(label: "Symbols", isSelected: false)
                    .accessibilityLabel("Filter by Symbols")
                DevelopFilterChip(label: "Text", isSelected: false)
...
private struct DevelopFilterChip: View {
    let label: String
    let isSelected: Bool
