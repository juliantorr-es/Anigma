...
struct AtlasView: View {
    ...
    @StateObject private var canvasController: AnigmaUI.CanvasController

    init() {
        self._canvasController = StateObject(wrappedValue: try! AnigmaUI.CanvasController())
    }
    ...
    private func syncAtlasToEngine() {
        Task {
            // syncScene unavailable - SceneNode initializer not accessible from app
