...
enum Bauhaus {
    ...
    enum Color {
        ...
        static let accent = SwiftUI.Color(red: 0.15, green: 0.85, blue: 0.55)
        static let accentLight = SwiftUI.Color(red: 0.35, green: 0.95, blue: 0.75)
        static let accentDark = SwiftUI.Color(red: 0.10, green: 0.65, blue: 0.45)
        static let accentHighContrast = SwiftUI.Color(red: 0.00, green: 0.55, blue: 0.35)
        static let errorHighContrast = SwiftUI.Color(red: 0.70, green: 0.05, blue: 0.15)
        static let textHighContrast = SwiftUI.Color(white: 0.05)

        // Status colors
        static let trusted = SwiftUI.Color(red: 0.15, green: 0.85, blue: 0.55)
        static let running = SwiftUI.Color(red: 0.15, green: 0.55, blue: 0.95)
        static let warning = SwiftUI.Color(red: 1.00, green: 0.65, blue: 0.15)
        static let error = SwiftUI.Color(red: 1.00, green: 0.25, blue: 0.35)
        static let success = SwiftUI.Color(red: 0.15, green: 0.85, blue: 0.55)

        // Queue specific
        static let queueRunning = SwiftUI.Color(red: 0.15, green: 0.55, blue: 0.95)
        static let queueComplete = SwiftUI.Color(red: 0.15, green: 0.85, blue: 0.55)
        static let queueQueued = SwiftUI.Color(white: 0.6)
        ...
        static let surfaceElevated = SwiftUI.Color(white: 0.22)
        static let cardBackground = SwiftUI.Color(white: 0.98).opacity(0.8)

        // Text
        static let textPrimary = SwiftUI.Color.primary
        static let textSecondary = SwiftUI.Color.secondary.opacity(0.8)
        static let textTertiary = SwiftUI.Color.secondary.opacity(0.5)

        // Borders - Ultra-thin
        static let border = SwiftUI.Color.primary.opacity(0.08)
        static let borderStrong = SwiftUI.Color.primary.opacity(0.15)
        static let active = SwiftUI.Color(red: 0.15, green: 0.85, blue: 0.55)

        static let governanceReadOnly = SwiftUI.Color(white: 0.5)
        static let governanceAllowed = SwiftUI.Color(red: 0.15, green: 0.85, blue: 0.55)
        static let governanceBlocked = SwiftUI.Color(red: 1.00, green: 0.25, blue: 0.35)
    ...
    // MARK: - Typography
     ...
     enum Font {
         static let displayXXL = SwiftUI.Font.system(size: 56, weight: .bold)
         static let displayXL = SwiftUI.Font.system(size: 48, weight: .bold)
         static let displayL = SwiftUI.Font.system(size: 40, weight: .bold)
         static let displayM = SwiftUI.Font.system(size: 32, weight: .semibold)
         static let displayS = SwiftUI.Font.system(size: 24, weight: .semibold)
         static let headline = SwiftUI.Font.system(size: 20, weight: .medium)
         ...
         static let smallBold = SwiftUI.Font.system(size: 10, weight: .bold)
         static let micro = SwiftUI.Font.system(size: 9)
         static let microBold = SwiftUI.Font.system(size: 9, weight: .bold)
         static let nano = SwiftUI.Font.system(size: 8)
         static let nanoBold = SwiftUI.Font.system(size: 8, weight: .bold)
         static let icon = SwiftUI.Font.system(size: 16)
         static let statNumber = SwiftUI.Font.system(size: 20, weight: .bold, design: .rounded)
         ...
         static let monoMicro = SwiftUI.Font.system(size: 9, design: .monospaced)
     }
 }
...
extension View {
    func bauhausCard(selected: Bool = false) -> some View {
        self
            ...
            .overlay(
                RoundedRectangle(cornerRadius: Bauhaus.Grid.cornerRadius)
                    .stroke(selected ? Bauhaus.Color.accent : Bauhaus.Color.border, lineWidth: selected ? 1.5 : 0.5)
            )
            .shadow(color: .black.opacity(selected ? 0.15 : 0.05), radius: selected ? 12 : 4, x: 0, y: selected ? 6 : 2)
            .clipShape(RoundedRectangle(cornerRadius: Bauhaus.Grid.cornerRadius))
    }
...
struct InfoRow: View {
    ...
    var body: some View {
        if let icon = icon, title != nil {
            // New style with icon (from AIOperationDetailView)
            HStack {
            ...
            // Classic style (from DesignSystem)
