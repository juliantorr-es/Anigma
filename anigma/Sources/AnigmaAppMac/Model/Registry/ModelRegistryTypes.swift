...
public enum ModelTrustTier: String, Codable, Sendable, CaseIterable, Identifiable {
...
public struct LegacyImportConfig: Codable, Sendable {
    public let modelId: String
    public let sourceType: String
    public let sourceLocation: String
    public let sourceRevision: String?
    ...
    public init(
        ...
        licenseDecision: String = "allowed",
        artifactHash: String,
        tokenizerHash: String? = nil,
        conversionReceiptId: String? = nil,
        backendCompatibility: ModelBackendCompatibility,
        importedAt: Date = Date(),
        trustTier: String = "compatible",
        taskKind: String = "llm.inference",
        backendFormat: String = "mlx",
        dimension: Int? = nil
    ) {
        self.modelId = modelId
        self.sourceType = sourceType
