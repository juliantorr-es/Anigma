...
private struct ConcreteEmbeddingComputing {
    let mlWorkerClient: MLWorkerClient
}

// MARK: - Disambiguated Protocol Conformances
// Explicitly conform to ContextumModule protocols (not ContractsCore versions)

extension ConcreteEmbeddingComputing: ContextumModule.EmbeddingComputing {
...
extension ConcreteModelRegistry: ContextumModule.ModelRegistryProtocol {}

/// Concrete type wrapping ModelRegistry for ContextumModule access
private actor ConcreteModelRegistry {
