...
public actor EvidenceSubstrate {
    ...
    private func validateOperationEvidence(
        operation: MLOperation,
        requirement: EvidenceRequirement
    ) async throws -> EvidenceValidationResult {
        ...
        guard chainValidation.isIntact else {
            return EvidenceValidationResult(
                ...
                requirement: requirement,
                violations: chainValidation.violations.map { violation in
                    EvidenceViolation(
                        id: UUID().uuidString,
        ...
        let evidenceStatus = assessEvidenceQuality(
        ...
        return EvidenceValidationResult(
            isValid: evidenceStatus.confidence >= requirementConfidence(requirement),
    ...
    private func assessEvidenceQuality(
        ...
        case 0.0..<0.3: return .insufficient
        case 0.3..<0.6: return .adequate
        case 0.6..<0.9: return .strong
    ...
    private func recordViolation(_ violation: EvidenceViolation, sessionId: String) async throws {
        let violationEvidence = Evidence(
            ...
            sessionId: sessionId,
            agentId: "system",
            contentHash: violation.id.sha256Hash,
            metadata: EvidenceMetadata(
                source: "EvidenceSubstrate",
...
public struct EvidenceEnforcementResult: Sendable, Codable {
    ...
    public let validation: EvidenceValidationResult
