...
public actor ArtifactIngestionAdapter {
    ...
    private func flushInternal() async throws {
        ...
        print("🔄 [ArtifactIngestionAdapter] Flushing \(commits.count) pending artifact commits...")
        ...
        print("✅ [ArtifactIngestionAdapter] Successfully flushed \(commits.count) commits")
        pendingCommits.removeAll()
    }
}
