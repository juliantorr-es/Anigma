...
public actor CosineSimilarityCapsuleWrapper {
    private var handle: CapsuleHandle<AnyObject>?
    private static let _shared = try? CosineSimilarityCapsuleWrapper()
    public static var shared: CosineSimilarityCapsuleWrapper? {
        _shared
    }
