...
public actor MCPServerImpl {
    ...
    private func sendToolList() async {
        let tools = ToolRegistry.shared.allContractSummaries().map { summary in
            [
                "name": summary.toolName,
                "description": summary.toolDescription,
                "origin": summary.origin.rawValue,
                "modifiesSystem": summary.modifiesSystem
            ]
        }
        let response: [String: Any] = ["jsonrpc": "2.0", "result": ["tools": tools]]
