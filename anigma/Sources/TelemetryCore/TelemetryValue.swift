...
public struct TelemetryTag: Sendable, Hashable {
    ...
    public init(_ raw: String) throws {
        ...
        guard TelemetryTag.allowedPrefixes.contains(where: trimmed.hasPrefix) else { throw TelemetryError.tagNotAllowed }
        self.value = trimmed
    }
