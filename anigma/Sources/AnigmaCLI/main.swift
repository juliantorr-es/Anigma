...
private let cliLogger = Logger(subsystem: "com.anigma.cli", category: "main")
        ...
        func run() async throws {
            ...
            if !skipOnboarding {
                do {
                    ...
                    cliLogger.warning("Could not check onboarding status: \(error.localizedDescription, privacy: .public)")
                    await ui.showWarning("Warning: Could not check onboarding status. Some features may be unavailable.")
                }
            }
