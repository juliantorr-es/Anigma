...
actor CLIConfiguration {
    ...
    func getDatabasePath() async throws -> String {
        ...
        let dbPath = anigmaDir.appendingPathComponent("anigma-cli.postgres").path
    ...
    // STUB_TRACK: cli-embedding-model-init – Embedding model initialization not implemented
    func getEmbeddingModel() async throws -> EmbeddingModel? {
        // STUB: Embedding model initialization not implemented
        print("⚠️  STUB INVOKED: CLIConfiguration.getEmbeddingModel()")
        print("   Embedding model initialization is not yet implemented - returning nil")
        print("   In real implementation, would initialize from config")
        return nil // Placeholder
    }

    // STUB_TRACK: cli-code-llm-init – Code LLM initialization not implemented
    func getCodeLLM() async throws -> CodeLLMModel? {
        // STUB: Code LLM initialization not implemented
        print("⚠️  STUB INVOKED: CLIConfiguration.getCodeLLM()")
        print("   Code LLM initialization is not yet implemented - returning nil")
        print("   In real implementation, would initialize from config/providers")
        return nil // Placeholder
    }
