...
public enum RLMEvidence {
    ...
    /// RLM-specific operation types that extend the standard OperationType.
    public enum RLMOperationType: String {
        ...
        /// Convert to standard OperationType.custom
        public var toOperationType: OperationType {
            .custom
        }
        
        /// Get the custom type string for OperationType.custom
