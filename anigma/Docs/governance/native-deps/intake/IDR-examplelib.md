# Intake Decision Record: examplelib

> **Decision Record for Native Library Intake**
>
> This document captures the decision framework for adding `examplelib` to Anigma's native dependency portfolio. This record must be completed and approved before any implementation begins.

## Status
**Status:** DRAFT  
**Created:** 2025-12-22T00:15:47Z  
...
- [ ] Attribution in anigma/Docs/licenses/examplelib.txt
...
**Native Surface Owner:** `Sources/ExternalC/{{CATEGORY}}/examplelib`  
...
- [ ] Create NATIVE.examplelib.md contract artifact
- [ ] Implement native surface in `Sources/ExternalC/{{CATEGORY}}/examplelib`
...
- **Contract Artifact:** `Docs/governance/contract-artifacts/NativeDeps/NATIVE.examplelib.md`
- **Registry Entry:** `Docs/governance/native-deps/registry/NativeDependencies.toml`
