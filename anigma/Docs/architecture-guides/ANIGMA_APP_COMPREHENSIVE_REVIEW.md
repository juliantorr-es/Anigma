...
**Central Store Pattern** (Observable + MainActor):
```swift
@MainActor
@Observable
final class AppStore {
    // 2741 lines of state management
...
**Strength**: Type-safe, @Observable for SwiftUI reactivity, @MainActor for thread safety.

**Weakness**: `AppStore.swift` at 2741 lines violates single responsibility principle.
