# AGENTS.md - OpenCode Agent Guidelines with Shared memory Integration
...
This document outlines how OpenCode agents should interact with the Anigma codebase, leveraging Shared memory for persistent context and improved effectiveness.

## Quick Start

1. **Always check Shared memory first**: `memory_store(mode: "search", query: "[topic]", scope: "project")`
2. **Use OpenCode plugins**: Worktree, KDCO primitives, Anigma CI tools
...
### **Core Guidelines**
- **[AGENTS_PLUGINS.md](AGENTS_PLUGINS.md)** - OpenCode plugin usage and patterns
