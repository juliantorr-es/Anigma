# ADR-0010: ExecutionCore Rails (SUPERSEDED)

> **⚠️ SUPERSEDED BY THE PRE-SIGNED MISSION MODEL**  
> This ADR defines the legacy "Real-Time Gated" execution model. While it remains valid for non-critical coordination, all high-performance AI execution has transitioned to **Pre-Signed Saturated Missions** (See `anigma/Docs/root-docs/architecture/security.md`).

> **Status:** Superseded  
> **Date:** 2026-04-16  
> **Superseded by:** Pre-Signed Saturated Mission Model
