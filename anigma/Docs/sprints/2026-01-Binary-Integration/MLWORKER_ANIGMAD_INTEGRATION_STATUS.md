...
> Historical binary-integration snapshot. This file reflects a January 2026 review and should not be treated as the canonical current status of `ml-worker`, `anigmad`, `harmonia`, or `doctrine`.
>
