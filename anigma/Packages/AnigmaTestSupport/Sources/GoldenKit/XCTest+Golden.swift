...
public extension Testing.Expectation {
    static func verifyAuditReceipt(receipt: PermissionReceipt, expectedType: CaptureMediaType) {
        #expect(receipt.type == expectedType)
        #expect(receipt.auditID != UUID.init(uuidString: "00000000-0000-0000-0000-000000000000"))
        #expect(receipt.timestamp > 0)
    }
}
