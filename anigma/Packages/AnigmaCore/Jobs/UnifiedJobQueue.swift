...
public actor UnifiedJobQueue {
    ...
    public init(
        ...
        metricsCollector: JobMetricsCollector? = nil
    ) {
    ...
    private func executeJob(_ record: JobRecord) async {
        ...
        let task = Task {
            ...
            do {
                ...
                let timedOut = error is JobError.executionTimeout
...
public struct UnifiedQueueStats: Sendable {
...
public protocol JobMetricsCollector: Sendable {
    func record(
        type: JobMetricType,
        jobId: JobId?,
        jobType: String?,
...
public enum JobMetricType: String, Sendable {
    case queueStarted
    case queueStopped
    case jobsRestored
    case jobSubmitted
