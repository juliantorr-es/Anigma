...
public enum NotificationSeverity: String, Codable, CaseIterable {
    case info
    case warning
    case error
    case critical
...
public enum NotificationDeliveryMethod: String, Codable, CaseIterable {
    case email
    case webhook
    case push
}
