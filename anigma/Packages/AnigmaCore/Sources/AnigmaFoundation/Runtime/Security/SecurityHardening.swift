...
public actor SecurityOperationRegistry {
    ...
    public static let defaultProfile = OperationProfile(
        operationId: "default",
        name: "Unregistered Operation",
        checkpointProfile: CheckpointProfileType.hard, // Deny by default
        riskLevel: RiskLevel.high,
        requiresAudit: true,
        allowedModes: [OperatingModeRaw.readOnly] // Only read-only by default
    )
    ...
    public func isAllowed(
        ...
        let modeRaw: AnigmaFoundation.OperatingModeRaw = switch mode {
...
public struct OperationProfile: Sendable {
    ...
    public let allowedModes: Set<AnigmaFoundation.OperatingModeRaw>
    public let requiredCapabilities: Set<String>
    public let maxSensitivity: PrivacySensitivity
    ...
    public init(
        ...
        allowedModes: Set<AnigmaFoundation.OperatingModeRaw> = [.readOnly, .assistive, .autopilot],
        requiredCapabilities: Set<String> = [],
        maxSensitivity: PrivacySensitivity = .internal,
...
public actor AuditIntegrityManager {
    ...
    public func record(
        ...
        sensitivity: PrivacySensitivity? = nil,
        description: String,
        metadata: [String: String] = [:]
    ) async {
...
public struct SandboxConfiguration: Sendable {
    ...
    public init(
        ...
        maxSensitivity: PrivacySensitivity,
...
public enum ContainmentError: Error, LocalizedError, Sendable {
    ...
    case sensitivityExceeded(PrivacySensitivity)
...
public actor ImmediateDeprovisioner {
    ...
    public func deprovision(
        ...
        if let log = auditLog {
            try? await log.record(
                eventType: AuditEventType.userDeprovisioned,
...
public enum StandardOperationProfiles {
    ...
    public static let viewEntity = OperationProfile(
        ...
        name: "View Entity",
        checkpointProfile: CheckpointProfileType.readOnly,
        riskLevel: RiskLevel.low,
        allowedModes: [OperatingModeRaw.readOnly, OperatingModeRaw.assistive, OperatingModeRaw.autopilot]
    )
    ...
    public static let createEntity = OperationProfile(
        ...
        checkpointProfile: CheckpointProfileType.soft,
        riskLevel: RiskLevel.low,
        allowedModes: [OperatingModeRaw.assistive, OperatingModeRaw.autopilot]
    )
    ...
    public static let deleteEntity = OperationProfile(
        ...
        name: "Delete Entity",
        checkpointProfile: CheckpointProfileType.hard,
        riskLevel: RiskLevel.high,
        allowedModes: [OperatingModeRaw.assistive], // No autopilot for deletes
    ...
    public static let createDspsCase = OperationProfile(
        ...
        checkpointProfile: CheckpointProfileType.checkpoint,
        riskLevel: RiskLevel.medium,
        allowedModes: [OperatingModeRaw.assistive, OperatingModeRaw.autopilot],
    ...
    public static let enrollStudent = OperationProfile(
        ...
        checkpointProfile: CheckpointProfileType.hard,
        riskLevel: RiskLevel.high,
        allowedModes: [OperatingModeRaw.assistive], // No autopilot for enrollments
        maxSensitivity: PrivacySensitivity.restricted
    )
    ...
    public static let recordGrade = OperationProfile(
        ...
        allowedModes: [OperatingModeRaw.assistive], // Never autopilot for grades
    ...
    public static let changeConfig = OperationProfile(
        ...
        checkpointProfile: CheckpointProfileType.hard,
        riskLevel: RiskLevel.critical,
        allowedModes: [OperatingModeRaw.assistive],
