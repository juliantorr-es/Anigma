...
/// Extension to integrate updates with GoverningController.
public extension GoverningController {
    ...
    func registerUpdateCheck(
        ...
        await registerWriteCheck(check)
    }
}
...
public extension GovernanceContracts.AuditEventType {
    static let updateAnnounced = GovernanceContracts.AuditEventType(rawValue: "update_announced")
    static let updateDrainStarted = GovernanceContracts.AuditEventType(rawValue: "update_drain_started")
    static let updateBlocked = GovernanceContracts.AuditEventType(rawValue: "update_blocked")
    static let updateCompleted = GovernanceContracts.AuditEventType(rawValue: "update_completed")
    static let updateRolledBack = GovernanceContracts.AuditEventType(rawValue: "update_rolled_back")
    static let migrationExecuted = GovernanceContracts.AuditEventType(rawValue: "migration_executed")
    static let migrationFailed = GovernanceContracts.AuditEventType(rawValue: "migration_failed")
    static let clientVersionBlocked = GovernanceContracts.AuditEventType(rawValue: "client_version_blocked")
    static let cohortRolloutChanged = GovernanceContracts.AuditEventType(rawValue: "cohort_rollout_changed")
}
