...
public actor DefaultWorkflowRegistry: WorkflowRegistry {
...
public actor DefaultWorkflowRunner: WorkflowRunner {
    private let registry: any WorkflowRegistry
    private var systemCache: [String: any System] = [:]

    public init(registry: any WorkflowRegistry) {
        ...
        for systemName in workflow.systemNames {
            ...
            if shouldRun {
                ...
                if timeoutPolicy.allowProgressExtension && systemElapsed < remainingTimeout * 0.8 {
                    // System completed within 80% of its allocated time
                }
