...
//  AnigmaCore
//
//  Receipt and ledger types for MakerEngine enhancement runs.
//
...
/// Receipt container with deterministic core and optional observational envelope.
...
public struct MakerReceiptPointer: Sendable, Codable {
    ...
    public init(runId: String, stepId: String, receiptPath: String, receiptSha256: String) {
        self.runId = runId
        self.stepId = stepId
...
public struct FileMakerReceiptPersister: MakerReceiptPersisting {
    ...
    public func persist(receipt: MakerReceipt, runId: String, stepId: StepId) throws -> MakerReceiptPointer {
        ...
        let receiptHash = Self.sha256Hex(of: data)
