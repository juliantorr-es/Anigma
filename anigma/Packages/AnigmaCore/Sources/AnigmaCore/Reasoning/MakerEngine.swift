...
public actor MakerEngine {
    ...
    private func buildEnhancementContext(for input: StepInput) -> EnhancementContext? {
        ...
        let inputHash = MakerReceiptEncoding.sha256Hex(of: inputData)
        let deterministicStepId = MakerReceiptEncoding.sha256Hex(
    ...
    private func deterministicOutputHash(for output: StepOutput) -> String? {
        ...
        return MakerReceiptEncoding.sha256Hex(of: data)
    }
    ...
    private func candidateTieBreakKey(
        ...
        let coreHash = MakerReceiptEncoding.sha256Hex(of: data)
        return MakerReceiptEncoding.sha256Hex(of: Data((determinismContext.seed + coreHash).utf8))
    }
    ...
    private func persistAdapterReceipt(
        ...
        let adapterDeterministicId = MakerReceiptEncoding.sha256Hex(
    ...
    private func recordEnhancementReceipt(
        ...
        do {
            ...
            // Receipt failures must not block MakerEngine execution.
        }
