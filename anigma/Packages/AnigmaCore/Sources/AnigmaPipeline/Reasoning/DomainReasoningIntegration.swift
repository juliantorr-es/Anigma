...
public actor DomainReasoningCoordinator {
    ...
    public func analyzeAllDomains() async throws -> PlatformAnalysisReport {
        ...
        for result in results {
            ...
            criticalIssues += result.issuesFound.filter { $0.severity == ReasoningIssueSeverity.critical }.count
        }
        ...
        return PlatformAnalysisReport(
            ...
            overallHealth: criticalIssues == 0 ? PlatformAnalysisReport.PlatformHealth.healthy : (criticalIssues < 3 ? PlatformAnalysisReport.PlatformHealth.degraded : PlatformAnalysisReport.PlatformHealth.critical)
        )
    }
    ...
    private func convertToIssues(_ result: ReasoningResult, domain: String) -> [DomainReasoningIssue] {
        guard result.outcome == ReasoningOutcome.foundViolation else { return [] }
        ...
        return result.violatedConstraints.map { constraint in
            DomainReasoningIssue(
                ...
                severity: ReasoningIssueSeverity.high,
                controlId: nil,
    ...
    private func storeScenarios(from result: ReasoningResult, domain: ReasoningDomain, title: String) async {
        ...
        let scenario = AdversarialScenario(
            ...
            discoveredBy: SpecializedKernelType.controlAttacker,
