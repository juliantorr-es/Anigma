...
/// Database-backed pipeline artifact store.
/// 
...
public actor DatabaseBackedPipelineArtifactStore: PipelineArtifactStore {
    ...
    public init(store: DatabaseArtifactStore, database: any DatabaseExecutor) {
        self.store = store
    ...
    /// Legacy initializer - accepts optional DatabaseActor.
    /// 
    /// DEPRECATED: Only composition roots should use this. Feature modules should use
    /// `init(store:database:)` instead and receive DatabaseExecutor via dependency injection.
    /// 
    ...
    @available(*, deprecated, message: "Use init(store:database:) with DatabaseExecutor instead.")
...
@available(*, deprecated, message: "Use DatabaseBackedPipelineArtifactStore with DatabaseExecutor instead.")
public typealias PipelineArtifactStoreImplementation = DatabaseBackedPipelineArtifactStore
