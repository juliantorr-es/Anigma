...
public actor CLIMLIntegration {
    ...
    private func chatCloud(
        ...
        let messages = [AnigmaCLIProviders.ChatMessage(role: "user", content: prompt)]
    ...
    private func blake3Hex(_ text: String) -> String {
        return BLAKE3Digest.hex(of: text)
    }
