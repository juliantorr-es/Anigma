...
public struct Vector2: Sendable, Hashable, Codable {
    ...
    public static func * (lhs: Vector2, rhs: Float) -> Vector2 {
        Vector2(x: lhs.x * Double(rhs), y: lhs.y * Double(rhs))
    }
}

/// 3D Vector type
public struct Vector3: Sendable, Hashable, Codable {
    public var x: Double
    public var y: Double
    public var z: Double
    ...
    public static func * (lhs: Vector3, rhs: Float) -> Vector3 {
        Vector3(x: lhs.x * Double(rhs), y: lhs.y * Double(rhs), z: lhs.z * Double(rhs))
    }
}

/// 4D Vector type
public struct Vector4: Sendable, Hashable, Codable {
    public var x: Double
    public var y: Double
    public var z: Double
    public var w: Double
    ...
    public static func * (lhs: Vector4, rhs: Float) -> Vector4 {
        Vector4(x: lhs.x * Double(rhs), y: lhs.y * Double(rhs), z: lhs.z * Double(rhs), w: lhs.w * Double(rhs))
    }
}
