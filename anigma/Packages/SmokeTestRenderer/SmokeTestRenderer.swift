...
struct SmokeTestRenderer {
    static func main() async {
        ...
        print("[Renderer] Receipt Outcome: \(receipt1.status.rawValue) -> \(receipt1.outcome)")
        ...
        print("[Renderer] Receipt Outcome: \(receipt2.status.rawValue) -> \(receipt2.outcome)")
        ...
        print("[Renderer] Receipt Outcome: \(receipt3.status.rawValue) -> \(receipt3.outcome)")
        ...
        print("[Renderer] Receipt Outcome: \(receipt4.status.rawValue) -> \(receipt4.outcome)")
        ...
        print("[Renderer] Receipt Outcome: \(receipt6.status.rawValue) -> \(receipt6.outcome)")
...
struct DirectAuthorityClient {
    ...
    func submitIntent(_ intent: ActionIntent) async -> Receipt {
