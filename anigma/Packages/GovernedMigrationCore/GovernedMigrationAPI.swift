...
/// Only composition roots (CLI tools) should create DatabaseActor directly.
...
public struct GovernedMigrationAPI {
    ...
    public init(database: any DatabaseExecutor, dbPath: String) {
    ...
    /// `init(database:dbPath:)` instead and receive DatabaseExecutor via dependency injection.
    /// 
