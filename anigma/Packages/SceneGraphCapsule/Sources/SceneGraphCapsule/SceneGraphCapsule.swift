...
/// Default diagnostics implementation using CapsuleCore components.
/// No longer using mock implementations in production-bound files.
internal final class DefaultCapsuleDiagnostics: CapsuleDiagnostics {
    public func beginSpan(
        ...
        NoOpDiagnosticSpan(name: name, category: category, correlationID: correlationID)
    }
    ...
    public func event(
        ...
        // Log to telemetry system or console in debug
    }
...
internal final class NoOpDiagnosticSpan: DiagnosticSpan {
    ...
    init(name: String, category: String, correlationID: String? = nil) {
        self.name = name
