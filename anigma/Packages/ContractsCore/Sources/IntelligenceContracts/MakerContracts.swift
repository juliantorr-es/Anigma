...
public struct StepCandidate: Sendable, Codable {
    ...
    /// Human-readable name (derived from action type).
    public var name: String { action.type.rawValue }
...
public struct StepContext: Sendable, Codable {
    ...
    public init(workflowId: String, sessionId: String, trustTier: TrustTier, allowedCapabilities: [String], zone: SecurityZone, deadline: Date? = nil) {
