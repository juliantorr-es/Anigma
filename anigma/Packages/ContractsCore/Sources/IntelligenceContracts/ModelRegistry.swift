...
/// Analysis of model capabilities and requirements
public struct ModelAnalysis: Sendable {
    public let supportsDynamicShapes: Bool
    ...
    public init(
        ...
        self.supportsDynamicShapes = supportsDynamicShapes
        self.maxSequenceLength = maxSequenceLength
        self.maxBatchSize = maxBatchSize
        self.recommendedPrecision = recommendedPrecision
