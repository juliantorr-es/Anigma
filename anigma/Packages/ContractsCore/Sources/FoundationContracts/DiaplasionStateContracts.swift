...
/// Content of document
/// Per Constructive Doctrine: Raw Data is not allowed in hot-path contracts.
/// Binary content must be stored as durable artifacts and referenced via ArtifactReference.
public struct DocumentContent: Sendable, Codable {
    public let format: ContentFormat
    public let text: String?
    public let binaryReference: ArtifactReference?
    ...
    public init(
        ...
        text: String? = nil,
        binaryReference: ArtifactReference? = nil,
        encoding: String? = nil,
        language: String? = nil,
...
public struct ProcessingOperation: Sendable, Codable {
    public let type: PlatformOperationType
...
/// Type of operation
public enum PlatformOperationType: String, Sendable, Codable {
