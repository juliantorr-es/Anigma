//
//  WriteGateContracts.swift
//  GovernanceContracts
//
//  Portable write-gate contract types for governance.
//  These are pure data/protocol shapes with no runtime dependencies.
//  Part of Tier 1 (Contracts) - may be imported by any tier.
//
//  Note: These types were previously in GovernanceCore (Tier 2) but are
//  actually portable contract types that belong in Tier 1.
//
...
public struct WriteGateDecision: Sendable, Codable {
    ...
    /// Converts to GovernanceDecision for compatibility with existing code.
