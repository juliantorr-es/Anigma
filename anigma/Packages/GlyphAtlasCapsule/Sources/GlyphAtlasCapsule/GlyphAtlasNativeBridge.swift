...
public enum GlyphAtlasNativeBridge {
    ...
    public static func shapeText(
        text: UnsafePointer<CChar>?,
        fontPath: UnsafePointer<CChar>?,
        fontSize: UInt32,
        shapedGlyphs: UnsafeMutablePointer<UnsafeMutablePointer<glyph_atlas_shaped_glyph_t>?>?,
        count: UnsafeMutablePointer<UInt32>?
    ) -> Int32 {
        return glyph_atlas_shape_text(text, fontPath, fontSize, shapedGlyphs, count)
    }
...
/// Shaped glyph structure
public struct glyph_atlas_shaped_glyph_t {
    public var index: UInt32
    public var codepoint: UInt32
    public var glyph_id: UInt32
    public var cluster: UInt32
    public var x_advance: Int32
    public var y_advance: Int32
    public var x_offset: Int32
    public var y_offset: Int32
}
...
@_silgen_name("glyph_atlas_shape_text")
public func glyph_atlas_shape_text(
    _ text: UnsafePointer<CChar>?,
    _ fontPath: UnsafePointer<CChar>?,
    _ fontSize: UInt32,
    _ shapedGlyphs: UnsafeMutablePointer<UnsafeMutablePointer<glyph_atlas_shaped_glyph_t>?>?,
    _ count: UnsafeMutablePointer<UInt32>?
) -> Int32
