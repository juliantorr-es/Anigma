...
public struct AttemptId: Hashable, Sendable, Codable, Identifiable, CustomStringConvertible {
    public let raw: UUID
...
public struct ArtifactId: Hashable, Sendable, Codable, Identifiable, CustomStringConvertible {
    public let raw: UUID
    public var id: UUID { raw }
...
public struct WorkBoardIntentResult: Sendable, Codable {
    ...
    public let snapshotId: String
    public let status: OperationOutcome
