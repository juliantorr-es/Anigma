...
extension DaemonServer {
    ...
    func handleCodexCreateSpace(
        ...
        return try await codexService.createSpace(space, principal: ctx.clientId)
    }
    ...
    func handleCodexCreatePage(
        ...
        return try await codexService.createPage(page, principal: ctx.clientId)
    }
