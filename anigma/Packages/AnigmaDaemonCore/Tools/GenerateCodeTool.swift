...
import HarmoniaV2Surface // For ChatMessage if needed, though we might construct prompt manually
...
public struct GenerateCodeTool: Tool {
    ...
    public func execute(
        params: Parameters,
        context: ToolContext
    ) async throws -> AnigmaPrimitives.ToolResult<Metadata> {
        ...
        // 4. Return Result
        return AnigmaPrimitives.ToolResult(
