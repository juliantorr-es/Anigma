...
public actor ObservationCaptureSystem: AsyncSystem {
    ...
    public func setup(world: World) async throws {
        await Logger.shared.info(
            "ObservationCaptureSystem starting", category: "ObservationCapture")
        ...
        await Logger.shared.info(
            "Loaded \(activeSessions.count) active sessions", category: "ObservationCapture")
    }
    ...
    public func teardown(world: World) async throws {
        ...
        await Logger.shared.info("ObservationCaptureSystem stopped", category: "ObservationCapture")
    }
