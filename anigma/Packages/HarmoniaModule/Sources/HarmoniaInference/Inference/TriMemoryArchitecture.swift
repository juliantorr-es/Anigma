...
actor TriMemoryService {
    ...
    init(config: TriMemoryConfig = .default) {
        self.config = config
    }
    ...
    func storeShortTerm(_ memory: ShortTermMemory) {
    ...
    func verifyIntegrity(memoryId: String) -> IntegrityCheckResult {
...
struct TriMemoryConfig: Sendable {
...
struct GovernanceDecision: Sendable {
...
struct ReleaseApproval: Sendable {
    public let isApproved: Bool
    public let releaseId: String
...
enum LongTermStoreResult: Sendable {
...
enum IntegrityCheckResult: Sendable {
...
struct MemoryAccessRecord: Sendable, Codable {
...
/// Memory operations.
enum MemoryOperation: String, Sendable, Codable {
    case store
    case retrieve
    case update
    case delete
...
struct SubjectMemoryBundle: Sendable {
...
actor MemoryContextBuilder {
    ...
    init(triMemory: TriMemoryService) {
...
enum ContextPriority: String, Sendable, Codable {
    case low
    case medium
    case high
    case critical
...
struct BuiltMemoryContext: Sendable {
