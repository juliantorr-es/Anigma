...
public struct StructuredReasoningModel: Sendable {
    ...
    public static let dspsReasoner = StructuredReasoningModel(
        ...
        supportedTasks: Set([StructuredTaskKind.dspsAnalysis, .workflowValidation, .policyCheck]),
        tier: .hybrid
    )
    ...
    public static let transcriptumReasoner = StructuredReasoningModel(
        ...
        supportedTasks: Set([StructuredTaskKind.transcriptumCheck, .policyCheck]),
        tier: .symbolic
    )
    ...
    public static let constraintSolver = StructuredReasoningModel(
        ...
        supportedTasks: Set([StructuredTaskKind.constraintSolving, .scheduling]),
        tier: .neural,
