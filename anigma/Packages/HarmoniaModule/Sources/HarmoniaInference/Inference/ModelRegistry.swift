...
public struct CapabilityProfile: Sendable, Codable {
    ...
    public let supportedTasks: Set<InferenceCore.InferenceTaskKind>
    ...
    public init(
        supportedTasks: Set<InferenceCore.InferenceTaskKind>,
...
public actor ModelRegistry {
    ...
    public func findCandidates(
        ...
        return models.values.filter { model in
            ...
            guard model.capabilities.supportedTasks.contains(task.kind.asCoreTaskKind()) else {
                return false
            }
...
extension ModelRegistry {
    ...
    public func statistics() -> ModelRegistryStatistics {
        ...
        return ModelRegistryStatistics(
...
public struct ModelRegistryStatistics: Sendable {
