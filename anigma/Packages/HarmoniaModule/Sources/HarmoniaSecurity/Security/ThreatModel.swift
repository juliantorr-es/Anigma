...
public enum ThreatActor: String, Sendable, Codable {
    ...
    public var description: String {
        ...
        case .maliciousAPIProvider:
            return "Malicious external API trying to inject malicious responses"
...
public enum ThreatCapability: String, Sendable, Codable {
    ...
    case policyViolation = "policy_incidental"
...
public actor TrustBoundaryEnforcer {
    ...
    public func canPerform(
        ...
        case .writeFiles, .gitOperations:
            ...
            return engineTrustTier >= TrustTier.gold && sourceZone == .trustedMutation

        case .networkCalls, .apiAccess:
            // Network requires at least silver and trusted network zone
            return engineTrustTier >= TrustTier.silver && sourceZone == .trustedNetwork
    ...
    /// Validation result for engine trust validation.
    public enum ValidationResult: Sendable {
        case valid(grant: CapabilityGrant?)
    ...
    public func validateEngineTrust(
        ...
        if assignedZone == .trustedMutation && engineTrustTier < TrustTier.gold {
            violations.append("Mutation engines require at least gold trust tier")
        }

        if assignedZone == .trustedNetwork && engineTrustTier < TrustTier.silver {
