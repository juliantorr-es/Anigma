...
public protocol TamperEvidenceSystemProtocol: Actor {
    ...
    func verifyChain() async throws -> ChainIntegrityReport
}
...
public actor TamperEvidenceSystem: TamperEvidenceSystemProtocol {
    ...
    public func appendEvent(
        ...
        let payloadHash = blake3Hex(payloadJSON)
        ...
        let eventHash = blake3Hex(eventJSON)
    ...
    public func createBundle(
        ...
        let manifestHash = blake3Hex(manifestJSON)
    ...
    public func verifyChain() async throws -> ChainIntegrityReport {
        ...
        for event in events {
            ...
            let eventJSON = try JSONSerialization.data(withJSONObject: eventData)
            let calculatedHash = blake3Hex(eventJSON)
    ...
    private func getHeadHash() async throws -> String {
        ...
        return blake3Hex("genesis".data(using: .utf8) ?? Data())
    }
