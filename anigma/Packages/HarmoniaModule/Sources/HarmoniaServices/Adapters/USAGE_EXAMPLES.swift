...
// TD-62d192 disposition: this file intentionally stays excluded from HarmoniaModule target.
// It is documentation/example-only and includes top-level demo workflows + stdout prints.
// Keeping it out of the production compile prevents accidental symbol/export drift.
