...
public actor RadicallyLegibleService {
    ...
    public func checkReasoningStep(
        context: TaskContext,
    ...
    public func recordReasoningStep(
        context: TaskContext,
    ...
    public func shouldTerminateEarly(
        context: TaskContext,
    ...
    public func registerCharter(_ charter: LearningCharter) async {
        await learningService.registerCharter(charter)
    }

    /// Get the charter for a tenant.
    public func getCharter(for tenantId: String) async -> LearningCharter? {
    ...
    public func generateReport(for bundle: TaskCompletionBundle) -> String {
        var lines: [String] = []
...
public struct TaskContext: Sendable {
    ...
    public let governor: ReasoningGovernor
    public let flowBuilder: DataFlowBuilder
...
public struct TaskCompletionBundle: Sendable {
    public let transparency: TransparencyBundle
    public let reasoningTrace: StructuredReasoningTrace
    public let learningTraceId: String?
}

// MARK: - Preset Charters

/// Preset charters for common institutional configurations.
public struct PresetLearningCharters {

    /// DSPS Charter for CCSF.
    public static var ccsfDSPS: LearningCharter {
        LearningCharter(
            tenantId: "ccsf",
            version: "1.0.0",
    ...
    public static var academicRecords: LearningCharter {
        LearningCharter(
            tenantId: "ccsf",
            version: "1.0.0",
...
public struct TransparencyDashboardData: Sendable, Codable {
    public let tenantId: String
    public let generatedAt: Date
    public let charterStatus: CharterStatus
    public let learningStats: LearningStats
    public let recentTasks: [TaskSummary]

    public struct CharterStatus: Sendable, Codable {
        public let hasCharter: Bool
        public let version: String?
        public let domains: [String]
        public let learningEnabled: Bool
        public let prohibitionCount: Int
    }

    public struct TaskSummary: Sendable, Codable {
        public let taskId: String
        public let domain: String
        public let completedAt: Date
        public let outcome: String
        public let learningEligible: Bool
        public let policyApplied: String
    }
}
