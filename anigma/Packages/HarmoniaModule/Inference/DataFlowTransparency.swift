...
/// Central service for generating and managing transparency artifacts.
public actor TransparencyService {
    ...
    public func beginTracking(taskId: String) -> DataFlowBuilder {
    ...
    public func getBuilder(for taskId: String) -> DataFlowBuilder? {
        flowBuilders[taskId]
    }
}
