...
public struct InstitutionalCharter: Sendable, Codable, Identifiable {
...
public enum CharterDomain: String, Sendable, Codable, CaseIterable {
    case dspsForms
...
public struct AuthoritativeSource: Sendable, Codable {
    public let name: String
...
/// Things the model must never optimize for.
public enum ProhibitedOptimization: String, Sendable, Codable, CaseIterable {
...
public enum ApproverRole: String, Sendable, Codable, CaseIterable {
    case dspsLead
    case legalCounsel
...
public struct CharterBehaviorConstraints: Sendable, Codable {
...
/// Ethical guardrails.
public struct EthicalGuardrails: Sendable, Codable {
...
public struct CharterAuditRequirements: Sendable, Codable {
...
public struct CharterAction: Sendable {
...
public enum CharterValidationResult: Sendable {
...
public enum CharterViolation: Sendable {
...
public struct InstitutionalModelProvenance: Sendable, Codable, Identifiable {
    public let id: String
...
public enum ProvenanceUpdateType: String, Sendable, Codable {
...
public struct ProvenanceSource: Sendable, Codable {
...
public enum ProvenanceSourceType: String, Sendable, Codable {
    case policyDocument
...
public struct InstitutionalModelBundle: Sendable, Codable, Identifiable {
    public let id: String
    public let tenantId: String
...
public struct InstitutionalModelComponents: Sendable, Codable {
...
public struct AdapterReference: Sendable, Codable {
...
public struct ModelReference: Sendable, Codable {
    public let modelId: String
    public let path: String
...
public struct SymbolicRule: Sendable, Codable {
...
public struct InstitutionalModelMetrics: Sendable, Codable {
...
public actor InstitutionalModelService {
...
public struct ShadowComparison: Sendable, Codable {
    public let id: String
    public let tenantId: String
...
public struct ComparisonMetrics: Sendable, Codable {
...
public enum PromotionDecision: Sendable {
...
public struct LearningConsent: Sendable, Codable {
...
public enum LearningScope: String, Sendable, Codable {
...
public enum LearningRestriction: String, Sendable, Codable {
...
public enum LearningSubmissionResult: Sendable {
