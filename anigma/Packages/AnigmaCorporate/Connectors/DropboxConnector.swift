...
public actor DropboxConnector: ConnectorProtocol {
    ...
    // STUB_TRACK: dropbox-write-back – Write-back operations not implemented for Dropbox
    public func execute(intent: any GovernanceIntent) async throws -> Data {
        // STUB: Write-back operations are not implemented for Dropbox connector
        print("⚠️  STUB INVOKED: DropboxConnector.execute() - write-back not implemented yet")
