...
public actor ClioConnector: ConnectorProtocol {
    ...
    // STUB_TRACK: clio-write-back – Write-back operations not implemented for Clio
    public func execute(intent: any GovernanceIntent) async throws -> Data {
        // STUB: Write-back operations are not implemented for Clio connector
        print("⚠️  STUB INVOKED: ClioConnector.execute() - write-back not implemented")
