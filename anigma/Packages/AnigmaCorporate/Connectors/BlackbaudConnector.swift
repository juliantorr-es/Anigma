...
public actor BlackbaudConnector: ConnectorProtocol {
    ...
    // STUB_TRACK: blackbaud-write-back – Write-back operations not implemented for Blackbaud
    public func execute(intent: any GovernanceIntent) async throws -> Data {
        // STUB: Write-back operations are not implemented for Blackbaud connector
        print("⚠️  STUB INVOKED: BlackbaudConnector.execute() - write-back not implemented")
