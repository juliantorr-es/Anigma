...
/// Concrete adapter that bridges PolytroposModule with ArtifactStoreModule for persistence.
public actor PolytroposArtifactStoreAdapter: ArtifactStoreAdapter {
    ...
    public func verifyAsset(artifactID: String) async throws -> VerificationResult {
