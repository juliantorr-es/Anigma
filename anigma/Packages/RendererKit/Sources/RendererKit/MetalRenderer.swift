...
public actor MetalRenderer: @preconcurrency RenderEngine {
    public let id: UUID
...
final actor MetalCommandEncoder: @preconcurrency RenderCommandEncoder {
...
final actor MetalRenderPassEncoder: @preconcurrency RenderPassEncoder {
    private let commandBuffer: MTLCommandBuffer
...
actor MetalShaderManager: @preconcurrency ShaderManager {
