...
public class DefaultMetricsAggregator: MetricsAggregator {
    ...
    public func getAggregatedMetrics(
        ...
        let percentiles: [Double: Double] = [
            50.0: sortedValues[Swift.max(0, Int(Double(count) * 0.5))],
            90.0: sortedValues[Swift.max(0, Int(Double(count) * 0.9))],
            95.0: sortedValues[Swift.max(0, Int(Double(count) * 0.95))],
            99.0: sortedValues[Swift.max(0, Int(Double(count) * 0.99))]
        ]
