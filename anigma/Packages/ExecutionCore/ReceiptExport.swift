...
// MARK: - CoreReceipt Export Manager
...
public class ReceiptExportManager {
    ...
    public static func exportToCSV(
        ...
        var csvContent = "CoreReceipt ID,Timestamp,Action Name,Authority,Decision,Reason Code,Inputs Hash,Outputs Hash,Previous Hash,Has Signature\n"
    ...
    public static func generateAuditBundle(
        ...
        let manifest = BundleManifest(
            ...
            files: [
                ...
                "receipts.csv": "CoreReceipt data in CSV format for analysis",
...
public struct AuditBundleMetadata: Codable {
    ...
    public init(exportTimestamp: Date, totalReceipts: Int, verificationIncluded: Bool, chainIntegrityVerified: Bool) {
        ...
        self.version = "1.0.0"
        self.format = "AI CoreReceipt Audit Bundle"
    }
}
...
public class PDFReportGenerator {
        ...
        for receipt in receipts {
            ...
            <div class="receipt">
                <div class="receipt-header">
                    CoreReceipt: \(receipt.receiptID) <span class="\(statusClass)">\(status)</span>
                </div>
    ...
    private func generateTextReport(receipts: [ReceiptWire], title: String) -> String {
        ...
        Report generated by Anigma Cathedral CoreReceipt System v1.0.0
        """
