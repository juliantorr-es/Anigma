...
//  ExecutionCore
//
//  Receipt wire types for deterministic encoding and persistence.
...
public enum ReceiptError: Error, LocalizedError {
    ...
    public var errorDescription: String? {
        ...
        case .receiptIDMismatch(let expected, let actual):
            return "Receipt ID mismatch. Expected: \(expected), got: \(actual)"
...
extension ReceiptWire {
    ...
    /// CRITICAL: Receipt ID MUST be derived from this method only
