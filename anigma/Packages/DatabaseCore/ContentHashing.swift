...
public enum ContentHashing {
    ...
    /// Compute BLAKE3 hash of the provided data.
    public static func computeHash(_ data: Data) -> String {
        return BLAKE3Digest.hex(of: data)
    }

    /// Compute BLAKE3 hash of the provided string encoded as UTF-8.
    public static func computeHash(_ string: String) -> String {
    ...
    public static let defaultAlgorithm = "blake3:1"
    ...
    public struct HashedBlob: Sendable {
        ...
        public init(content: Data, contentHash: String? = nil, algorithm: String? = nil) {
            ...
            self.contentHash = contentHash ?? computeHash(content)
        }
