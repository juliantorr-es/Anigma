...
typedef enum {
    ANIGMA_SCENE_GRAPH_MUTATION_ATTACH = 0,
    ANIGMA_SCENE_GRAPH_MUTATION_DETACH = 1,
    ANIGMA_SCENE_GRAPH_MUTATION_UPDATE_TRANSFORM = 2
} anigma_scene_graph_mutation_kind_t;

typedef struct {
    anigma_scene_graph_mutation_kind_t kind;
    uint64_t entity_id;
    anigma_scene_node_t node;
    anigma_transform_t transform;
} anigma_scene_graph_mutation_t;
...
// Batch ANE-accelerated operations
