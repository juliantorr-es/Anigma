...
public actor LSPConnection {
    ...
    private func readFromPipe(_ pipe: Pipe) async throws -> Data {
        ...
        // STUB_TRACK: lsp-framing – Proper LSP message framing not implemented
        print("⚠️  STUB INVOKED: LSPConnection.readFromPipe()")
        print("   LSP message framing not implemented - reading raw data without header parsing")
