...
public struct SelfHostCommand: AsyncParsableCommand {
    public static var configuration: CommandConfiguration {
        CommandConfiguration(
            commandName: "self-host",
            abstract: "Self-host project operations.",
            subcommands: [SelfHostInitCommand.self, SelfHostStatusCommand.self]
        )
    }
...
public struct SelfHostInitCommand: AsyncParsableCommand {
    public static var configuration: CommandConfiguration {
        CommandConfiguration(
            commandName: "init",
    ...
    public func run() async throws {
        ...
        do {
            ...
            let controller = await provider.controller(for: spec.id)
...
public struct SelfHostStatusCommand: AsyncParsableCommand {
    public static var configuration: CommandConfiguration {
        CommandConfiguration(
            commandName: "status",
...
public struct SelfHostInit: AsyncParsableCommand {
    public static var configuration: CommandConfiguration {
        CommandConfiguration(
            ...
            abstract: "Legacy alias for `self-host init`."
        )
    }
    ...
    public func run() async throws {
        print("ℹ️ Legacy command detected: `harmonia self-host-init` → use `harmonia self-host init`.")
        var command = SelfHostInitCommand()
        command.force = force
...
public struct SelfHostStatus: AsyncParsableCommand {
    public static var configuration: CommandConfiguration {
        CommandConfiguration(
            ...
            abstract: "Legacy alias for `self-host status`."
        )
    }
    ...
    public func run() async throws {
        print("ℹ️ Legacy command detected: `harmonia self-host-status` → use `harmonia self-host status`.")
        var command = SelfHostStatusCommand()
