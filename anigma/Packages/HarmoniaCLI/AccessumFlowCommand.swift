//
//  AccessumFlowCommand.swift
//  HarmoniaCLI
//
//  Consolidated CLI wrapper for AccessumFlow orchestrator
//
...
public struct AccessumFlow: AsyncParsableCommand {
    ...
    private static func outlineumSpecURL(repoRoot: URL) throws -> URL {
        if let envOverride = ProcessInfo.processInfo.environment[Self.outlineumSpecOverrideEnvironmentKey]?
...
extension AccessumFlow {
    public struct Admin: AsyncParsableCommand {
        ...
        @Option(
            ...
            help: "Path to the migration trace database (default: shared PostgreSQL database)"
        )
