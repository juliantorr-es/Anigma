//
//  DiaplasionPipelineCommand.swift
//  HarmoniaCLI
//
//  Consolidated CLI wrapper for DiaplasionPipeline
//
...
public struct DiaplasionPipeline: AsyncParsableCommand {
    ...
    public func run() async throws {
        ...
        let plainTextHash = Self.blake3Hex(data: Data(normalizedText.utf8))
        ...
        let pdfHash = Self.blake3Hex(data: pdfData)
    ...
    private static func blake3Hex(data: Data) -> String {
    ...
    private static func verifyReplay(
        ...
        guard blake3Hex(data: storedPlainData) == trace.plainTextHash else {
        ...
        let pdfHash = blake3Hex(data: pdfData)
        ...
        guard blake3Hex(data: storedPdfData) == trace.pdfHash else {
    ...
    private static func pdfContentHash(for normalizedText: String, pipelineVersion: String) -> String {
        ...
        return blake3Hex(data: Data(payload.utf8))
    }
