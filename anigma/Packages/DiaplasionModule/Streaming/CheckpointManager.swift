...
public struct CheckpointManagementSystem: System {
    ...
    private func handleCheckpointOperation(_ operation: CheckpointOperationComponent, for entity: EntityID) async throws {
        ...
        case .save:
            ...
            logWarning("Direct component-based checkpoint saving not fully implemented for type Any", category: "Diaplasion")
            
        case .load:
            // Same here, cannot call loadCheckpoint without knowing T at compile time here
            logWarning("Direct component-based checkpoint loading not fully implemented", category: "Diaplasion")
