...
public actor CPUSoftwareRenderer: Renderer {
    ...
    public func beginFrame() async throws -> BoxedRenderCommandEncoder {
        ...
        return BoxedRenderCommandEncoder(CPUSoftwareCommandEncoder(frameBuffer: frameBuffer))
    }
...
final class CPUSoftwareCommandEncoder: RenderCommandEncoder {
    private var frameBuffer: [UInt32]?
    ...
    func beginRenderPass(_ descriptor: RenderPassDescriptor) throws -> BoxedRenderPassEncoder {
        return BoxedRenderPassEncoder(CPUSoftwareRenderPassEncoder(frameBuffer: frameBuffer))
    }
...
final class CPUSoftwareRenderPassEncoder: RenderPassEncoder {
    private var frameBuffer: [UInt32]
