...
public actor MetalRenderer: Renderer {
    ...
    public func beginFrame() async throws -> any RenderCommandEncoder {
...
final actor MetalCommandEncoder: RenderCommandEncoder {
    ...
    func beginRenderPass(_ descriptor: RenderPassDescriptor) throws -> BoxedRenderPassEncoder {
        return BoxedRenderPassEncoder(MetalRenderPassEncoder(commandBuffer: commandBuffer, descriptor: descriptor))
    }
