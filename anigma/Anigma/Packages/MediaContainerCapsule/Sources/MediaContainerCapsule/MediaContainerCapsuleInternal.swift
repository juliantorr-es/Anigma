...
public enum StreamType: String, CaseIterable, Sendable {
    case video = "video"
    case audio = "audio"
...
public struct ContainerAnalysis: Sendable {
    ...
    public init(format: ContainerFormat, duration: TimeInterval, streams: [StreamInfo], 
...
public struct StreamExtractionResult: Sendable {
    public let streamInfo: StreamInfo
    public let outputPath: String
    public let fileSize: Int64
    public let processingTime: TimeInterval
    
    public init(streamInfo: StreamInfo, outputPath: String, fileSize: Int64, processingTime: TimeInterval) {
