...
- `Sources/NewCapsule/`: Public API and implementation.
- `Sources/NewCapsuleNative/`: (Optional) C++ bridge for performance-critical logic.
- `Tests/NewCapsuleTests/`: Unit, Contract, and Golden tests.
