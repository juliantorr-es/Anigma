...
let coreTargets: [Target] = [
    ...
    .target(name: "TextChunkingCapsule", dependencies: ["AnigmaNativeShims", "AnigmaPrimitives", "CapsuleCore", "TextChunkingNative"], path: "Packages/TextChunkingCapsule/Sources/TextChunkingCapsule", swiftSettings: strictConcurrencySettings + [.interoperabilityMode(.Cxx)]),
    ...
    .target(name: "MediaFingerprintCapsule", dependencies: ["AnigmaNativeShims", "AnigmaPrimitives", "CapsuleCore", "MediaFingerprintNative"], path: "Packages/MediaFingerprintCapsule/Sources/MediaFingerprintCapsule", swiftSettings: [.unsafeFlags(["-strict-concurrency=minimal"]), .interoperabilityMode(.Cxx)]),
    ...
    .target(name: "TextPipelineCapsule", dependencies: ["AnigmaNativeShims", "AnigmaPrimitives", "CapsuleCore", "TextPipelineNative"], path: "Packages/TextPipelineCapsule/Sources/TextPipelineCapsule", swiftSettings: strictConcurrencySettings + [.interoperabilityMode(.Cxx)]),
    .target(name: "VectorIndexCapsule", dependencies: ["AnigmaPrimitives", "CapsuleCore", "VectorIndexNative"], path: "Packages/VectorIndexCapsule/Sources/VectorIndexCapsule", swiftSettings: strictConcurrencySettings + [.interoperabilityMode(.Cxx)]),
    ...
    .target(name: "AnigmaTestSupport", dependencies: ["AnigmaCore", "AnigmaPrimitives", "ContractsCore", "DatabaseCore", "PolytroposModule"], path: "Packages/AnigmaTestSupport", swiftSettings: strictConcurrencySettings + [.interoperabilityMode(.Cxx)]),
