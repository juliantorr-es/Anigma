...
let coreTargets: [Target] = [
    .target(name: "PDFCapsule", dependencies: ["AnigmaNativeShims", "AnigmaPrimitives", "CapsuleCore", "TelemetryCore", "PDFNative"], path: "Packages/PDFCapsule/Sources/PDFCapsule", swiftSettings: strictConcurrencySettings + [.interoperabilityMode(.Cxx)]),
    ...
    .target(name: "TessellationCapsule", dependencies: ["CapsuleCore"], path: "Packages/TessellationCapsule/Sources/TessellationCapsule", swiftSettings: strictConcurrencySettings + [.interoperabilityMode(.Cxx)]),
    ...
    .target(name: "LayoutEngineCapsule", dependencies: ["AnigmaNativeShims", "AnigmaPrimitives", "CapsuleCore", "TelemetryCore", "LayoutEngineNative", "PDFNative"], path: "Packages/LayoutEngineCapsule/Sources/LayoutEngineCapsule", swiftSettings: strictConcurrencySettings + [.interoperabilityMode(.Cxx)]),
    ...
    .target(name: "RankFusionCapsule", dependencies: ["AnigmaNativeShims", "AnigmaPrimitives", "CapsuleCore", "TelemetryCore", "RankFusionNative"], path: "Packages/RankFusionCapsule/Sources/RankFusionCapsule", swiftSettings: strictConcurrencySettings + [.interoperabilityMode(.Cxx)]),
...
let testTargets: [Target] = [
    ...
    .testTarget(name: "TessellationCapsuleTests", dependencies: ["TessellationCapsule", "CapsuleCore"], path: "Tests/TessellationCapsuleTests", swiftSettings: strictConcurrencySettings + [.interoperabilityMode(.Cxx)]),
    ...
    .testTarget(name: "Tier3CapsuleTests", dependencies: ["TextChunkingCapsule", "VectorIndexCapsule", "RankFusionCapsule", "PDFCapsule", "LayoutEngineCapsule", "CapsuleCore", "TelemetryCore", "AnigmaPrimitives"], path: "Tests/Tier3CapsuleTests", swiftSettings: strictConcurrencySettings + [.interoperabilityMode(.Cxx)]),
