#ifndef MEDIA_FINGERPRINT_CAPSULE_H
#define MEDIA_FINGERPRINT_CAPSULE_H
...
typedef enum {
    ...
    ANIGMA_FINGERPRINT_DIFFERENCE_HASH = 1,
    ANIGMA_FINGERPRINT_WAVELET_HASH = 2,
    ANIGMA_FINGERPRINT_PERCEPTUAL_HASH = 3,
...
#endif // MEDIA_FINGERPRINT_CAPSULE_H