...
private let artifactListLogger = Logger(subsystem: "com.anigma.app", category: "artifacts")
                ...
                Task {
                    if url.startAccessingSecurityScopedResource() {
                        ...
                        do {
                            ...
                            artifactListLogger.error("Error reading file: \(error.localizedDescription, privacy: .public)")
                        }
                    }
                }
            case .failure(let error):
                artifactListLogger.error("Error selecting file: \(error.localizedDescription, privacy: .public)")
            }
        }
    }
}
