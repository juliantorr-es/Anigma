...
func withRetry<T>(
    ...
    while true {
        do {
            ...
            errorLogger.warning("Operation failed (attempt \(attempt, privacy: .public)): \(error.localizedDescription, privacy: .public). Retrying in \(String(format: "%.1f", delay), privacy: .public)s")
