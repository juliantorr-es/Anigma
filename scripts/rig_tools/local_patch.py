...
from rig_tools import context_compression, mlx_local, schema_validation
...
def _run_model(prompt: str, *, model: str | None, timeout_seconds: int) -> dict[str, Any]:
    return mlx_local.generate_summary(prompt=prompt, model=model or mlx_local.SUMMARY_MODEL, max_tokens=900, timeout_seconds=timeout_seconds)
