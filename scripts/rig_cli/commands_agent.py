...
def register(subparsers, helpers):
    ...
    status.set_defaults(handler=lambda args: _emit(_status_payload(helpers)))
...
def _status_payload(helpers) -> dict:
    agents = agent_launcher.available_agents(helpers.repo_root)
